...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", "ensembler/dev"]
...
latex_documents = [
    (master_doc, "PyGromosTools.tex", "PyGromosTools Documentation", "PyGromosTools", "manual"),
]
...
man_pages = [(master_doc, "PyGromosTools", "PyGromosTools Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "PyGromosTools",
        "PyGromosTools Documentation",
        author,
        "PyGromosTools",
        "The code is a python representation of Gromos in python ",
        "Miscellaneous",
    ),
]
