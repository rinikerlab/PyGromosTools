...
class _GromosXX(_gromosClass):
    ...
    def __init__(
        ...
        super().__init__(
            in_bin_dir=gromosXX_bin_dir, _check_binary=_check_binary
...
class GromosXX(_GromosXX):
    ...
    def __init__(self, gromosXX_bin_dir: str = None, _check_binary: bool = False):
        super().__init__(gromosXX_bin_dir=gromosXX_bin_dir, _check_binary=_check_binary)
