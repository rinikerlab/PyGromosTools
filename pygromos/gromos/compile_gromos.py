...
def install_gromos(root_dir:str, 
                   ...
                   with_debug:bool=False, nCore:int=1):
    """
    ...
    if(do_compile):
        ...
        if(_do_gromosPP):
            ...
            if(not os.path.exists(gromosPP_build_path) or recompile_from_scratch):
                _configure_gromosPP_autotools(build_dir=gromosPP_build_path, binary_dir=binary_dir, with_omp=gromosPP_with_omp, with_debug=with_debug)
...
def _configure_gromosPP_autotools(build_dir:str, binary_dir:str=None, with_omp:bool=False, with_debug: bool = False):
    """
