...
class Trc(mdtraj.Trajectory):
    ...
    def angles(
        self,
        atom_pairs: List[Tuple[int, int, int]],
        periodic: bool = True,
        opt: bool = True,
    ) -> pd.DataFrame:
        ...
        """
        arr = mdtraj.compute_angles(self, atom_pairs=atom_pairs, periodic=periodic, opt=opt)
        time_scale = pd.Series(data=self.time, name="time")
        return pd.DataFrame(
    ...
    def dihedrals(
        self, atom_pairs: List[Tuple[int, int, int, int]], periodic: bool = True, opt: bool = True
    ) -> pd.DataFrame:
        ...
        """
        arr = mdtraj.compute_dihedrals(self, atom_pairs=atom_pairs, periodic=periodic, opt=opt)
        time_scale = pd.Series(data=self.time, name="time")
        return pd.DataFrame(
            {
