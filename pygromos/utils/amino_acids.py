...
GlutamicAcid=amino_acid(name="glutamic acid", oneLetter="E", threeLetter="GLU", numUnitedAtoms=10, numFullAtomistic=None)

Phenylalanine=amino_acid(name="phenylalanine", oneLetter="F", threeLetter="PHE", numUnitedAtoms=17, numFullAtomistic=None)
...
Lysine_positive=amino_acid(name="lysine_positive", oneLetter="K", threeLetter="LYSH", numUnitedAtoms=13, numFullAtomistic=None)
