...
class test_queuing_system(unittest.TestCase):
    ...
    def test_submit(self):
        ...
        self.submit_to_queue(sub_job=sub_job)
    ...
    def test_submit_jobAarray_to_queue(self):
        ...
        sub_job = Submission_job(jobName="test_job", 
                                ...
                                start_job=1,
                                end_job=1)
        self.submit_jobAarray_to_queue(sub_job=sub_job)
    ...
    def test_submit_jobAarray_to_queue1_10(self):
        sub_job2 = Submission_job(jobName="test_job", 
                                ...
                                start_job=1,
                                end_job=10)
        self.submit_jobAarray_to_queue(sub_job=sub_job2)

    def test_search_queue_for_jobname(self):
        if self.file_class == _SubmissionSystem:
            return
        search_job = "Test"
        self.search_queue_for_jobname(job_name=search_job)

    def test_get_jobs_from_queue(self):
        if self.file_class == _SubmissionSystem:
            return
        get_jobs_with = "Test"
        self.get_jobs_from_queue(job_text=get_jobs_with)
